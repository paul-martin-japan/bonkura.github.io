 ...
 *
 * Modified by the Nerdery for Poetry Foundation
 */
...
(function($) {
    $.fn.selectedTextSharer= function(options) {
		...
		function getSelectionText(){
			...
			//--- 20130528 - mej - added for Poetry Foundation to prevent linebreaks becoming non-spaces
			if( selectionTxt.toString ){
				selectionTxt = selectionTxt.toString();
			}
			selectionTxt = selectionTxt.replace(/\n+\s*/g , " / ");
